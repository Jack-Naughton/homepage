var app = function() {
    ...
    let o, a;
    function l(e, t) {
        return o || (o = document.createElement("a")),
        o.href = t,
        e === o.href
    }
    function u(t, n, r) {
    ...
    function re(t, s, i, o, l, u, c, d=[-1]) {
        ...
        if (f.ctx = i ? i(t, s.props || {}, ((e,n,...r)=>{
            ...
            return f.ctx && l(f.ctx[e], f.ctx[e] = s) && (!f.skip_bound && f.bound[e] && f.bound[e](s),
            m && ne(t, e)),
            n
        }
        )) : [],
    ...
    function ie(e) {
        ...
        return {
            ...
            p(e, [r]) {
                o && o.p && (!n || 4 & r) && f(o, i, e, e[2], n ? h(i, e[2], r, null) : m(e[2]), null),
    ...
    function Me(e) {
        let t, n, r, s, i, o, a, l, u, c, d, h = e[1].img && Le(e), f = e[1].artist && Ae(e);
        return {
            c() {
                t = w("div"),
                n = w("a"),
            ...
            p(e, t) {
                e[1].img ? h ? h.p(e, t) : (h = Le(e),
                h.c(),
                h.m(r, s)) : h && (h.d(1),
                h = null),
                e[1].artist ? f ? f.p(e, t) : (f = Ae(e),
                f.c(),
                f.m(i, null)) : f && (f.d(1),
                f = null),
    ...
    function Pe(e) {
        ...
        return {
            c() {
                ...
                i.c(),
                n = x(),
                M(t, "class", "p-2 mb-2 border border-custom-mg flex items-center last:mb-0"),
    ...
    function Le(e) {
        ...
        return {
            ...
            p(e, s) {
                ...
                2 & s && r !== (r = e[1].artist + " - " + e[1].title) && M(t, "alt", r)
            },
            d(e) {
                e && y(t)
            }
    ...
    function Ae(e) {
        let t, n, r, s, i, o = e[1].artist + "", a = e[1].title + "";
        return {
            c() {
                t = w("p"),
                n = _(o),
    ...
    function He(e, t, n) {
        let r, {userGuesses: s} = t, {maxAttempts: i} = t, {currentHeardle: o} = t, {todaysGame: a} = t;
        return e.$$set = e=>{
    ...
    function Xe(t) {
        ...
        return {
            c() {
                ...
                s = w("div"),
                i = w("div"),
                i.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 5L6 9H2v6h4l5 4zM22 9l-6 6M16 9l6 6"></path></svg>',
                o = x(),
                a = w("div"),
                l = w("p"),
            ...
            p(e, t) {
                e[4].gameIsActive ? c ? c.p(e, t) : (c = et(e),
                c.c(),
                c.m(a, null)) : c && (c.d(1),
                c = null)
            },
    ...
    function Qe(e) {
        let t, n, r, s, i, o, a, l, u, c, d, h, f, m, v, k, b, S, D, Y, C, O, P = mt(e[10]) + "", L = mt(e[14] ? e[4].isPrime ? e[7].slice(-1)[0] : e[2].maxAttempts * e[2].attemptInterval : e[3]) + "", A = !e[11] && 1 == e[0] && tt();
        function N(e, t) {
        ...
        S.$on("click", e[5]),
        {
            ...
            p(e, n) {
                ...
                (!O || 49152 & n[0]) && T(i, "width", (e[14] ? e[15] : "100") + "%"),
                H === (H = N(e)) && I ? I.p(e, n) : (I.d(1),
                I = H(e),
                I && (I.c(),
                I.m(s, null))),
                (!O || 1024 & n[0]) && P !== (P = mt(e[10]) + "") && $(v, P);
                const r = {};
                131072 & n[0] | 16 & n[1] && (r.$$scope = {
                    dirty: n,
                    ctx: e
                }),
                S.$set(r),
                (!O || 16540 & n[0]) && L !== (L = mt(e[14] ? e[4].isPrime ? e[7].slice(-1)[0] : e[2].maxAttempts * e[2].attemptInterval : e[3]) + "") && $(C, L)
            },
            i(e) {
                O || (Z(S.$$.fragment, e),
                O = !0)
    ...
    function st(e) {
        let t, n = Array(e[2].maxAttempts + 1), r = [];
        for (let t = 0; t < n.length; t += 1)
            r[t] = ot(Be(e, n, t));
        return {
            c() {
            ...
            p(e, s) {
                if (4 & s[0]) {
                    const s = n.length;
                    let i;
                    for (n = Array(e[2].maxAttempts + 1),
                    i = s; i < n.length; i += 1)
                        Be(e, n, i),
                        r[i] || (r[i] = ot(),
                        r[i].c(),
                        r[i].m(t.parentNode, t));
                    for (i = n.length; i < s; i += 1)
                        r[i].d(1);
                    r.length = n.length
                }
            },
    ...
    function it(e) {
        let t, n = Array(Math.floor(e[3] / e[2].attemptInterval)), r = [];
        for (let t = 0; t < n.length; t += 1)
            r[t] = at(ze(e, n, t));
        return {
            c() {
            ...
            p(e, s) {
                if (12 & s[0]) {
                    const s = n.length;
                    let i;
                    for (n = Array(Math.floor(e[3] / e[2].attemptInterval)),
                    i = s; i < n.length; i += 1)
                        ze(e, n, i),
                        r[i] || (r[i] = at(),
                        r[i].c(),
    ...
    function ot(e) {
        ...
        return {
            c() {
                t = w("div"),
                M(t, "class", "bg-custom-bg w-px h-full")
            },
            m(e, n) {
                g(e, t, n)
            },
        ...
        return {
            ...
            p(e, t) {
                if (192 & t[0]) {
                    ...
                    n = 0; n < i.length; n += 1) {
                        const s = Ue(e, i, n);
                        o[n] ? o[n].p(s, t) : (o[n] = ut(s),
                        o[n].c(),
                        o[n].m(r.parentNode, r))
                    }
                    for (; n < o.length; n += 1)
                        o[n].d(1);
                    o.length = i.length
    ...
    function ut(e) {
        ...
        return {
            c() {
                ...
                T(t, "left", e[7][e[32]] / e[7].slice(-1)[0] * 100 + "%"),
                Y(t, "bg-custom-bg", e[32] < e[6] - 1),
                Y(t, "bg-custom-mg", e[32] > e[6] - 1),
                Y(t, "bg-custom-line", e[32] == e[6] - 1)
            },
            m(e, n) {
                g(e, t, n)
            },
            p(e, n) {
                128 & n[0] && T(t, "left", e[7][e[32]] / e[7].slice(-1)[0] * 100 + "%"),
                64 & n[0] && Y(t, "bg-custom-bg", e[32] < e[6] - 1),
                64 & n[0] && Y(t, "bg-custom-mg", e[32] > e[6] - 1),
                64 & n[0] && Y(t, "bg-custom-line", e[32] == e[6] - 1)
            },
            d(e) {
                e && y(t)
            }
    ...
    function ct(t) {
        ...
        return {
            c() {
                n = w("div"),
                n.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg>',
    ...
    function dt(e) {
        ...
        }),
        {
            ...
            p(e, t) {
                const r = {};
                131072 & t[0] && (r.musicIsPlaying = e[17]),
                n.$set(r)
            },
            i(e) {
                r || (Z(n.$$.fragment, e),
    ...
    function ht(e) {
        ...
        r = o[n] = i[n](e),
        {
            c() {
                t = w("div"),
                r.c(),
                M(t, "class", "flex justify-center items-center text-custom-fg h-14 w-14 border-2 rounded-full relative overflow-hidden")
            },
            m(e, r) {
                g(e, t, r),
                o[n].m(t, null),
    ...
    function ft(e) {
        ...
        i = m[s] = f[s](e),
        {
            c() {
                ...
                a = w("div"),
                u = w("div"),
                l(t.src, n = "https://w.soundcloud.com/player/api.js") || M(t, "src", "https://w.soundcloud.com/player/api.js"),
                M(a, "class", "hidden")
            },
            m(n, i) {
                p(je.head, t),
    ...
    function pt(e, t, n) {
        ...
        let M;
        function $() {
            (g = SC.Widget("soundcloud" + d.id)).bind(SC.Widget.Events.READY, (function() {
                g.getCurrentSound((function(e) {
                    "BLOCK" === e.policy && n(8, p = !0),
                    u("updateSong", {
                        currentSong: e
                    })
                }
                )),
                g.bind(SC.Widget.Events.PAUSE, (function() {
                    S(!1)
                }
                )),
                g.bind(SC.Widget.Events.PLAY, (function() {
                    S(!0),
                    x || (pe("startGame", {
                        name: "startGame"
                    }),
                ...
                g.bind(SC.Widget.Events.PLAY_PROGRESS, (function(e) {
                    1 == s ? m.isPrime ? (n(9, y = e.currentPosition / a[o - 1] * 100),
                    e.currentPosition > a[o - 1] && (g.pause(),
                    g.seekTo(0))) : (n(9, y = e.currentPosition / (c * h.attemptInterval) * 100),
                    e.currentPosition > c * h.attemptInterval && (g.pause(),
                    g.seekTo(0))) : (n(9, y = e.currentPosition / f * 100),
                    e.currentPosition > f && (g.pause(),
                    g.seekTo(0))),
        ...
        P((()=>{
            ...
            e.allow = "autoplay",
            e.height = 0,
            e.src = "https://w.soundcloud.com/player/?url=" + d.url + "&cache=" + d.id,
            M.appendChild(e),
            k = !0,
            w && (setTimeout((()=>{
                n(12, b = !0)
        ...
        e.$$.update = ()=>{
            ...
            213 & e.$$.dirty[0] && n(15, l = m.isPrime ? a[o - 1] / a.slice(-1)[0] * 100 : c / h.maxAttempts * 100)
        }
        ,
        [c, d, h, f, m, ()=>{
            g.toggle()
        }
        , o, a, p, y, v, _, b, M, s, l, i, r, function() {
            w = !0,
            k && (setTimeout((()=>{
                n(12, b = !0)
            }
    ...
    var wt = yt((function(e, t) {
        ...
        n = function() {
            ...
            var a = function(e) {
              ...
              , l = function(e, t) {
                ...
                for (var r in t) {
                    ...
                    if ("inside" === r)
                        ...
                        r in n ? n[r] = s : n.setAttribute(r, s)
                }
                return n
            }
              , u = function(e, t) {
                return e = e.toString().toLowerCase(),
                t ? e.normalize("NFD").replace(/[\u0300-\u036f]/g, "").normalize("NFC") : e
            }
              , c = function(e, n) {
                return l("mark", t({
                    innerHTML: e
                ...
                "loose" === s) {
                    var l = (e = e.replace(/ /g, "")).length
                      ...
                      , h = Array.from(t).map((function(t, n) {
                        return d < l && a[n] === e[d] && (t = o ? c(t, o) : t,
                        d++),
                        t
                    }
                    )).join("");
                    ...
                    var f = a.indexOf(e);
                    if (~f)
                        return e = t.substring(f, f + e.length),
              ...
              , w = function(e) {
                e.isOpen || ((e.wrapper || e.input).setAttribute(p, !0),
                e.list.removeAttribute("hidden"),
                e.isOpen = !0,
                d("open", e))
            }
              , k = function(e) {
                e.isOpen && ((e.wrapper || e.input).setAttribute(p, !1),
              ...
              , S = function(e, t, n) {
                (n = n >= 0 ? n : e.cursor) < 0 || (e.feedback.event = t,
                v(e, n),
                d("selection", e),
                k(e))
            };
            function M(e, n) {
                ...
                return new Promise((function(s, i) {
                    ...
                    function(e, t, n) {
                        ...
                        try {
                            return e.feedback instanceof Error ? s() : (m(o, e),
                            e.resultsList && function(e) {
                                var n = e.resultsList
                                  , r = e.list
                                  , s = e.resultItem
                                  , i = e.feedback
            ...
            function D(e) {
                ...
                return new Promise((function(r, s) {
                    ...
                    function(e) {
                        var n, r, s, i = e.events, o = (n = function() {
                            return M(e)
                        }
                        ,
                        r = e.debounce,
      ...
      , kt = _t(2);
    function _t(e) {
        if ("number" != typeof e || Number.isNaN(e) || e < 1 || e === Number.POSITIVE_INFINITY)
            throw new Error("`" + e + "` is not a valid argument for `n-gram`");
        return function(t) {
            var n, r, s = [];
            if (null == t)
                return s;
            if (r = t.slice ? t : String(t),
            (n = r.length - e + 1) < 1)
                return s;
            for (; n--; )
                s[n] = r.slice(n, n + e);
    ...
    function xt(e, t) {
        let n, r, s, i;
        Array.isArray(e) ? s = e.map((e=>String(e).toLowerCase())) : (n = String(e).toLowerCase(),
        s = 1 === n.length ? [n] : kt(n)),
        Array.isArray(t) ? i = t.map((e=>String(e).toLowerCase())) : (r = String(t).toLowerCase(),
        i = 1 === r.length ? [r] : kt(r));
        let o, a, l, u = -1, c = 0;
        for (; ++u < s.length; )
            for (o = s[u],
    ...
    function Dt(e) {
        ...
        b.$on("click", e[5]),
        {
            c() {
                ...
                d = x(),
                h = w("div"),
                h.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',
                f = x(),
                m = w("div"),
                Q(v.$$.fragment),
                _ = x(),
            ...
            m(r, y) {
                ...
                ee(b, m, null),
                $ = !0,
                T || (Y = [S(c, "input", e[8]), S(h, "click", e[9])],
                T = !0)
            },
            p(e, [t]) {
                16 & t && D(c, e[4]);
    ...
    function Tt(e, t, n) {
        let r, {allOptions: s} = t, {currentAttempt: i} = t, {config: o} = t, {isPrime: a} = t;
        const l = {
            focus() {
    ...
    function Ct(e) {
        ...
        return {
            c() {
                ...
                a = w("div"),
                l = w("button"),
                l.innerHTML = '<svg class="w-7 h-7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',
                u = x(),
                D && D.c(),
            ...
            p(e, t) {
                (!d || 1 & t) && $(i, e[0]),
                D && D.p && (!d || 32 & t) && f(D, b, e, e[5], d ? h(b, e[5], t, null) : m(e[5]), null)
            },
            i(e) {
                d || (Z(D, e),
                d = !0)
    ...
    function Ot(e) {
        ...
        return {
            c() {
                t = w("button"),
                t.innerHTML = '<svg class="w-7 h-7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',
                n = x(),
                a && a.c(),
                t.autofocus = !0,
    ...
    function Pt(e) {
        ...
        a = h[o] = d[o](e),
        {
            ...
            m(r, a) {
                ...
                e[7](i),
                l = !0,
                u || (c = [S(window, "keydown", e[4]), S(t, "click", e[3])],
                u = !0)
            },
            p(e, [t]) {
                let n = o;
    ...
    function Nt(t) {
        ...
        return {
            c() {
                n = w("div"),
                n.innerHTML = '<p class="mb-3">A respectful homage to <a href="https://www.nytimes.com/games/wordle/index.html" title="Wordle">Wordle</a>, with a musical twist.</p> \n\n<p class="mb-3">Each Heardle is semi-randomly plucked from a long list of popularly streamed artists. Much love, and all relevant copyright, to those featured.</p> \n\n<p class="mb-3"><del>Heardle was made for a small group of friends</del> I steal</p> \n\n</p>',
                M(n, "class", "text")
            },
            m(e, t) {
                g(e, n, t)
...
//                r.innerHTML = '<span class="kofitext svelte-1d3p4dy"><img src="https://storage.ko-fi.com/cdn/cup-border.png" alt="Ko-fi donations" class="kofiimg mr-2 mb-1 svelte-1d3p4dy"/>Support us on Ko-Fi</span><svg xmlns="http://www.w3.org/2000/svg" class="ml-2" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h13M12 5l7 7-7 7"></path></svg>',
...
//                M(r, "href", "https://ko-fi.com/heardle"),
    ...
    function Gt(t) {
        ...
        return {
            c() {
                n = w("div"),
                r = w("div"),
                r.innerHTML = '<span class="text-custom-negative"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="currentColor" stroke="" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg></span> \n        <span class="px-1 text-custom-line text-sm">Much love to all our supporters:</span>',
                s = x(),
                i = w("div"),
                o = w("p"),
                a = w("span"),
                a.innerHTML = '<svg class="inline" xmlns="http://www.w3.org/2000/svg" width="8" height="8" viewBox="0 0 24 24" fill="currentColor" stroke="" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>',
                l = x(),
                u = _(t[0]),
                c = x(),
                d = w("div"),
    ...
    function zt(t) {
        ...
        u = new Bt({}),
        {
            c() {
                n = w("p"),
                n.textContent = "No support; I steal",
                r = x(),
                s = w("p"),
//                s.textContent = "If you've enjoyed playing, please consider supporting us – we'll do our best to keep improving Heardle for everyone.",
    ...
    function Zt(e, t, n) {
        ...
        function o() {
            let e = Math.floor(i / 3600)
              ...
              , s = Math.floor(i % 60);
            n(0, r = ("00" + e).slice(-2) + ":" + ("00" + t).slice(-2) + ":" + ("00" + s).slice(-2)),
            i--,
    ...
    function Qt(e) {
        let t, n, r, s, i, o, a, l, u, c, d, h, f, m, k, b, S, D, T, Y, C, O, P, L = Jt[e[3]] + "", A = Array(e[1].maxAttempts), N = [];
        ...
        O = new Rt({}),
        {
            c() {
                ...
                T = w("div"),
                Y = w("div"),
                Y.innerHTML = '<span class="text-custom-negative"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" stroke="" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg></span> \n                <span class="px-1">you</span>',
                C = x(),
                Q(O.$$.fragment),
            ...
            p(e, n) {
                if ((!P || 8 & n) && L !== (L = Jt[e[3]] + "") && $(r, L),
                3 & n) {
                    let t;
                    for (A = Array(e[1].maxAttempts),
                    t = 0; t < A.length; t += 1) {
                        const r = Xt(e, A, t);
                        N[t] ? N[t].p(r, n) : (N[t] = on(r),
                        N[t].c(),
                        N[t].m(i, null))
                    }
                    for (; t < N.length; t += 1)
    ...
    function en(t) {
        ...
        return {
            c() {
                n = w("div"),
                M(n, "class", "w-4 h-1 m-0.5 bg-custom-fg")
            },
            m(e, t) {
                g(e, n, t)
            },
    ...
    function sn(e) {
        ...
        return {
            c() {
                t = w("div"),
                M(t, "class", "w-4 h-1 m-0.5 bg-custom-mg")
            },
            m(e, n) {
                g(e, t, n)
            },
    ...
    function ln(e) {
        ...
        return {
            ...
            p(e, t) {
                3 & t && o !== (o = e[1].attemptIntervalAlt[e[0].length - 1] / 1e3 + "") && $(n, o),
                3 & t && a !== (a = e[1].attemptIntervalAlt[e[0].length - 1] / 1e3 > 1 ? "s" : "") && $(s, a)
            },
            d(e) {
                e && y(t),
                e && y(n),
    ...
    function cn(e) {
        ...
        return {
            c() {
                ...
                M(t, "class", "tracking-widest uppercase text-xs text-custom-line p-3 pb-0 text-center")
            },
            m(e, n) {
                g(e, t, n)
            },
    ...
    function fn(e, t, n) {
        ...
        [r, i, o, l, u, c, ()=>{
            ...
            if (!navigator.share || !/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent))
                ...
                navigator.clipboard.writeText(o)) : Promise.reject("There was a problem copying your result to the clipboard");
            navigator.share({
                text: o
            }).then((()=>{
                pe("clickSharePanel", {
    ...
    function _n(e) {
        let t, n, r, s, i, o, a, l, u, c, d, h, f, m, k, b, S, D, T, Y, C, O, P, L, A, N, H, I, W, R, F, G, E, j, B = (e[6] > 0 ? (e[8] / e[6] * 100).toFixed(1) : 0) + "", z = e[7].slice(-1)[0] + "", U = Math.max(...e[7]) + "", V = e[9], J = [];
    ...
    function bn(e) {
        ...
        return {
            ...
            p(e, n) {
                ...
                22 & n && Y(t, "text-custom-positive", e[17] == e[1] - 1 && 0 != e[4] && e[2]),
    ...
    function Dn(e, t, n) {
        let {userStats: r} = t
          ...
          , {guessRef: m} = t
          , p = [];
        for (let e = 0; e < s.maxAttempts + 1; e++)
            p[e] = 0;
        let g = 0;
        if (r.length > 0) {
            l = !0;
            ...
            for (let e in r)
                !0 === r[e].hasFinished && (++u,
                !0 === r[e].gotCorrect ? (d[r[e].id] = 1,
                ++h,
                ++p[r[e].score - 1],
                p[r[e].score - 1] > g && (g = p[r[e].score - 1])) : (++p[s.maxAttempts],
                p[s.maxAttempts] > g && (g = p[s.maxAttempts])));
            c = d.reduce(((e,t)=>(t ? e[e.length - 1]++ : e.push(0),
            e)), [0])
        }
        return e.$$set = e=>{
    ...
    var Yn = yt((function(e, t) {
        e.exports = function() {
                    ...
                    n) {
                        ...
                        for (i = 0; i < arguments.length; i++) {
                            ...
                            "object" == typeof arguments[i]) {
                                for (o in s += "\n[" + i + "] ",
                                arguments[0])
                                    a(arguments[0], o) && (s += o + ": " + arguments[0][o] + ", ");
                                s = s.slice(0, -2)
                            } else
                                s = arguments[i];
                            l.push(s)
            ...
            function fe(e, t, n) {
                e.isValid() && !isNaN(n) && ("FullYear" === t && le(e.year()) && 1 === e.month() && 29 === e.date() ? (n = ce(n),
                e._d["set" + (e._isUTC ? "UTC" : "") + t](n, e.month(), Qe(n, e.month()))) : e._d["set" + (e._isUTC ? "UTC" : "") + t](n))
            }
            function me(e) {
            ...
            function pe(e, t) {
                ...
                } else if (Y(this[e = re(e)]))
                    return this[e](t);
                return this
            }
            var ge, ye = /\d/, ve = /\d\d/, we = /\d{3}/, ke = /\d{4}/, _e = /[+-]?\d{6}/, xe = /\d\d?/, be = /\d\d\d\d?/, Se = /\d\d\d\d\d\d?/, Me = /\d{1,3}/, $e = /\d{1,4}/, De = /[+-]?\d{1,6}/, Te = /\d+/, Ye = /[+-]?\d+/, Ce = /Z|[+-]\d\d:?\d\d/gi, Oe = /Z|[+-]\d\d(?::?\d\d)?/gi, Pe = /[+-]?\d+(\.\d{1,3})?/, Le = /[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i;
            function Ae(e, t, n) {
                ge[e] = Y(t) ? t : function(e, r) {
                    return e && n ? n : t
                }
            }
            function Ne(e, t) {
            ...
            function He(e) {
                return Ie(e.replace("\\", "").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g, (function(e, t, n, r, s) {
                    return t || n || r || s
                }
                )))
            }
            ...
            var Ee, je = 0, Be = 1, ze = 2, Ue = 3, Ve = 4, Je = 5, Ke = 6, Ze = 7, qe = 8;
            function Xe(e, t) {
                return (e % t + t) % t
            }
            function Qe(e, t) {
            ...
            function lt(e, t, n) {
                ...
                r = 0; r < 12; r++) {
                    ...
                    n || this._monthsParse[r] || (i = "^" + this.months(s, "") + "|^" + this.monthsShort(s, ""),
            ...
            function ut(e, t) {
                ...
                if ("string" == typeof t)
                    if (/^\d+$/.test(t))
                        ...
                        return e;
                return n = Math.min(e.date(), Qe(e.year(), t)),
            ...
            function ht(e) {
                return this._monthsParseExact ? (a(this, "_monthsRegex") || mt.call(this),
                e ? this._monthsShortStrictRegex : this._monthsShortRegex) : (a(this, "_monthsShortRegex") || (this._monthsShortRegex = rt),
                this._monthsShortStrictRegex && e ? this._monthsShortStrictRegex : this._monthsShortRegex)
            }
            function ft(e) {
                return this._monthsParseExact ? (a(this, "_monthsRegex") || mt.call(this),
                e ? this._monthsStrictRegex : this._monthsRegex) : (a(this, "_monthsRegex") || (this._monthsRegex = st),
            ...
            function wt(e, t, n, r, s, i, o) {
                var a;
                return e < 100 && e >= 0 ? (a = new Date(e + 400,t,n,r,s,i,o),
                isFinite(a.getFullYear()) && a.setFullYear(e)) : a = new Date(e,t,n,r,s,i,o),
                a
            }
            function kt(e) {
                var t, n;
            ...
            function xt(e, t, n, r, s) {
                ...
                return a <= 0 ? o = pt(i = e - 1) + a : a > pt(e) ? (i = e + 1,
                o = a - pt(e)) : (i = e,
                o = a),
                {
                    year: i,
            ...
            function bt(e, t, n) {
                var r, s, i = _t(e.year(), t, n), o = Math.floor((e.dayOfYear() - i - 1) / 7) + 1;
                return o < 1 ? r = o + St(s = e.year() - 1, t, n) : o > St(e.year(), t, n) ? (r = o - St(e.year(), t, n),
                s = e.year() + 1) : (s = e.year(),
                r = o),
                {
                    week: r,
            ...
            function Bt(e, t, n) {
                ...
                r = 0; r < 7; r++) {
                    ...
                    this._weekdaysParse[r] || (i = "^" + this.weekdays(s, "") + "|^" + this.weekdaysShort(s, "") + "|^" + this.weekdaysMin(s, ""),
            ...
            function Jt(e) {
                return this._weekdaysParseExact ? (a(this, "_weekdaysRegex") || qt.call(this),
                e ? this._weekdaysStrictRegex : this._weekdaysRegex) : (a(this, "_weekdaysRegex") || (this._weekdaysRegex = It),
                this._weekdaysStrictRegex && e ? this._weekdaysStrictRegex : this._weekdaysRegex)
            }
            function Kt(e) {
                return this._weekdaysParseExact ? (a(this, "_weekdaysRegex") || qt.call(this),
                e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex) : (a(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = Wt),
                this._weekdaysShortStrictRegex && e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex)
            }
            function Zt(e) {
                return this._weekdaysParseExact ? (a(this, "_weekdaysRegex") || qt.call(this),
                e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex) : (a(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Rt),
            ...
            function fn(e) {
                for (var t, n, r, s, i = 0; i < e.length; ) {
                    for (t = (s = hn(e[i]).split("-")).length,
                    n = (n = hn(e[i + 1])) ? n.split("-") : null; t > 0; ) {
                        if (r = mn(s.slice(0, t).join("-")))
                            return r;
                        if (n && n.length >= t && dn(s, n) >= t - 1)
                            break;
                        t--
                    }
                    i++
            ...
            function pn(e, t) {
                var n;
                return e && ((n = u(t) ? vn(e) : gn(e, t)) ? an = n : "undefined" != typeof console && console.warn && console.warn("Locale " + e + " not found. Did you forget to load it?")),
                an._abbr
            }
            function gn(e, t) {
                if (null !== t) {
            ...
            function yn(e, t) {
                if (null != t) {
                    var n, r, s = ln;
                    null != un[e] && null != un[e].parentLocale ? un[e].set(O(un[e]._config, t)) : (null != (r = mn(e)) && (s = r._config),
                    t = O(s, t),
                    null == r && (t.abbr = e),
            ...
            function kn(e) {
                var t, n = e._a;
                return n && -2 === g(e).overflow && (t = n[Be] < 0 || n[Be] > 11 ? Be : n[ze] < 1 || n[ze] > Qe(n[je], n[Be]) ? ze : n[Ue] < 0 || n[Ue] > 24 || 24 === n[Ue] && (0 !== n[Ve] || 0 !== n[Je] || 0 !== n[Ke]) ? Ue : n[Ve] < 0 || n[Ve] > 59 ? Ve : n[Je] < 0 || n[Je] > 59 ? Je : n[Ke] < 0 || n[Ke] > 999 ? Ke : -1,
            ...
            function Yn(e) {
                var t, n, r, s, i, o, a = e._i, l = _n.exec(a) || xn.exec(a);
                if (l) {
                    for (g(e).iso = !0,
                    t = 0,
                    n = Sn.length; t < n; t++)
            ...
            function Ln(e, t, n) {
                return !e || Nt.indexOf(e) === new Date(t[0],t[1],t[2]).getDay() || (g(n).weekdayMismatch = !0,
                n._isValid = !1,
                !1)
            }
            function An(e, t, n) {
            ...
            function Nn(e) {
                var t, n = Dn.exec(Pn(e._i));
                if (n) {
                    if (t = Cn(n[4], n[3], n[2], n[5], n[6], n[7]),
                    !Ln(n[1], t, e))
                        return;
                    e._a = t,
            ...
            function Rn(e) {
                ...
                if (!e._d) {
                    ...
                    null != e._dayOfYear && (i = In(e._a[je], r[je]),
                    (e._dayOfYear > pt(i) || 0 === e._dayOfYear) && (g(e)._overflowDayOfYear = !0),
                    ...
                    24 === e._a[Ue] && 0 === e._a[Ve] && 0 === e._a[Je] && 0 === e._a[Ke] && (e._nextDay = !0,
                    e._a[Ue] = 0),
            ...
            function Fn(e) {
                ...
                r = In(t.W, 1),
                ((s = In(t.E, 1)) < 1 || s > 7) && (l = !0)) : (i = e._locale._week.dow,
                o = e._locale._week.doy,
                u = bt(Kn(), i, o),
                n = In(t.gg, e._a[je], u.year),
                r = In(t.w, u.week),
                null != t.d ? ((s = t.d) < 0 || s > 6) && (l = !0) : null != t.e ? (s = t.e + i,
                (t.e < 0 || t.e > 6) && (l = !0)) : s = i),
                r < 1 || r > St(n, i, o) ? g(e)._overflowWeeks = !0 : null != l ? g(e)._overflowWeekday = !0 : (a = xt(n, r, s, i, o),
                e._a[je] = a.year,
            ...
            function Gn(e) {
                if (e._f !== r.ISO_8601)
                    if (e._f !== r.RFC_2822) {
                        e._a = [],
                        g(e).empty = !0;
                        var t, n, s, i, o, a, l = "" + e._i, u = l.length, c = 0;
                        for (s = B(e._f, e._locale).match(H) || [],
                        t = 0; t < s.length; t++)
                            i = s[t],
                            (n = (l.match(Ne(i, e)) || [])[0]) && ((o = l.substr(0, l.indexOf(n))).length > 0 && g(e).unusedInput.push(o),
                            l = l.slice(l.indexOf(n) + n.length),
                            c += n.length),
                            R[i] ? (n ? g(e).empty = !1 : g(e).unusedTokens.push(i),
                            Ge(i, n, e)) : e._strict && !n && g(e).unusedTokens.push(i);
            ...
            function Un(e) {
                ...
                b(t) ? new x(kn(t)) : (d(t) ? e._d = t : i(n) ? jn(e) : n ? Gn(e) : Vn(e),
                y(e) || (e._d = null),
                e))
            }
            function Vn(e) {
                var t = e._i;
                u(t) ? e._d = new Date(r.now()) : d(t) ? e._d = new Date(t.valueOf()) : "string" == typeof t ? Hn(e) : i(t) ? (e._a = h(t.slice(0), (function(e) {
                    return parseInt(e, 10)
                }
                )),
                Rn(e)) : o(t) ? Bn(e) : c(t) ? e._d = new Date(t) : r.createFromInputFallback(e)
            }
            ...
            function rr(e) {
                var t, n, r = !1;
                for (t in e)
                    if (a(e, t) && (-1 === Ee.call(nr, t) || null != e[t] && isNaN(e[t])))
                        return !1;
            ...
            function ur(e, t, n) {
                var r, s = Math.min(e.length, t.length), i = Math.abs(e.length - t.length), o = 0;
                for (r = 0; r < s; r++)
            ...
            function pr(e, t, n) {
                ...
                if (null != e) {
                    ...
                    return !this._isUTC && t && (s = mr(this)),
                    this._offset = e,
                    this._isUTC = !0,
                    null != s && this.add(s, "m"),
                    i !== e && (!t || this._changeInProgress ? Lr(this, Tr(e - i, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0,
                    r.updateOffset(this, !0),
            ...
            function Tr(e, t) {
                var n, r, s, i = e, o = null;
                return ar(e) ? i = {
                    ms: e._milliseconds,
                    d: e._days,
                    M: e._months
                } : c(e) || !isNaN(+e) ? (i = {},
                t ? i[t] = +e : i.milliseconds = +e) : (o = $r.exec(e)) ? (n = "-" === o[1] ? -1 : 1,
                i = {
                    y: 0,
                    d: ce(o[ze]) * n,
                    h: ce(o[Ue]) * n,
                ...
                i = {
                    ...
                    m: Yr(o[7], n),
                    s: Yr(o[8], n)
                }) : null == i ? i = {} : "object" == typeof i && ("from"in i || "to"in i) && (s = Or(Kn(i.from), Kn(i.to)),
                (i = {}).ms = s.milliseconds,
                i.M = s.months),
                r = new or(i),
            ...
            function Or(e, t) {
                var n;
                return e.isValid() && t.isValid() ? (t = fr(t, e),
                e.isBefore(t) ? n = Cr(e, t) : ((n = Cr(t, e)).milliseconds = -n.milliseconds,
                n.months = -n.months),
                n) : {
                    milliseconds: 0,
                    months: 0
            ...
            function Wr(e) {
                var t, n, r = o(e) && !l(e), s = !1, i = ["years", "year", "y", "months", "month", "M", "days", "day", "d", "dates", "date", "D", "hours", "hour", "h", "minutes", "minute", "m", "seconds", "second", "s", "milliseconds", "millisecond", "ms"];
            ...
            function Fr(e) {
                var t, n, r = o(e) && !l(e), s = !1, i = ["sameDay", "nextDay", "lastDay", "nextWeek", "lastWeek", "sameElse"];
                for (t = 0; t < i.length; t += 1)
                    n = i[t],
                    s = s || a(e, n);
                return r && s
            ...
            function Zr(e, t, n) {
                ...
                if (!this.isValid())
                    return NaN;
                if (!(r = fr(e, this)).isValid())
                    return NaN;
                switch (s = 6e4 * (r.utcOffset() - this.utcOffset()),
                t = re(t)) {
                case "year":
                    i = qr(this, r) / 12;
                    break;
            ...
            function Qr(e) {
                ...
                return n.year() < 0 || n.year() > 9999 ? j(n, t ? "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYYYY-MM-DD[T]HH:mm:ss.SSSZ") : Y(Date.prototype.toISOString) ? t ? this.toDate().toISOString() : new Date(this.valueOf() + 60 * this.utcOffset() * 1e3).toISOString().replace("Z", j(n, "Z")) : j(n, t ? "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYY-MM-DD[T]HH:mm:ss.SSSZ")
            }
            function es() {
                if (!this.isValid())
                    return "moment.invalid(/* " + this._i + " */)";
                var e, t, n, r, s = "moment", i = "";
            ...
            function ns(e, t) {
                return this.isValid() && (b(e) && e.isValid() || Kn(e).isValid()) ? Tr({
                    to: this,
                    from: e
            ...
            function ys(e) {
                ...
                case "hour":
                    t = this._d.valueOf(),
                    t += ds - fs(t + (this._isUTC ? 0 : this.utcOffset() * cs), ds) - 1;
                    break;
                case "minute":
                    t = this._d.valueOf(),
                    t += cs - fs(t, cs) - 1;
            ...
            function Ts(e, t) {
                ...
                for (n = 0,
                s = o.length; n < s; ++n)
                    switch ("string" == typeof o[n].since && (i = r(o[n].since).startOf("day"),
                    o[n].since = i.valueOf()),
                    typeof o[n].until) {
                    case "undefined":
                        o[n].until = 1 / 0;
            ...
            function Ns(e) {
                return a(this, "_erasNameRegex") || Es.call(this),
                e ? this._erasNameRegex : this._erasRegex
            }
            function Hs(e) {
                return a(this, "_erasAbbrRegex") || Es.call(this),
                e ? this._erasAbbrRegex : this._erasRegex
            }
            function Is(e) {
                return a(this, "_erasNarrowRegex") || Es.call(this),
            ...
            function Zs(e, t, n, r, s) {
                var i;
                return null == e ? bt(this, r, s).year : (t > (i = St(e, r, s)) && (t = i),
                qs.call(this, e, t, n, r, s))
            }
            ...
            Re(["yo"], (function(e, t, n, r) {
                ...
                n._locale.eraYearOrdinalParse ? t[je] = n._locale.eraYearOrdinalParse(e, s) : t[je] = parseInt(e, 10)
            }
            )),
            F(0, ["gg", 2], 0, (function() {
            ...
            li.toISOString = Qr,
            li.inspect = es,
            "undefined" != typeof Symbol && null != Symbol.for && (li[Symbol.for("nodejs.util.inspect.custom")] = function() {
            ...
            function pi(e, t, n, r) {
                ...
                t = void 0),
                t = t || "");
                var s, i = vn(), o = e ? i._week.dow : 0, a = [];
                if (null != n)
                    return fi(t, (n + o) % 7, r, "day");
                for (s = 0; s < 7; s++)
                    a[s] = fi(t, (s + o) % 7, r, "day");
                return a
            }
            function gi(e, t) {
            ...
            function xi() {
                var e = this._data;
                return this._milliseconds = _i(this._milliseconds),
            ...
            function Di() {
                var e, t, n, r, s, i = this._milliseconds, o = this._days, a = this._months, l = this._data;
                return i >= 0 && o >= 0 && a >= 0 || i <= 0 && o <= 0 && a <= 0 || (i += 864e5 * $i(Yi(a) + o),
                o = 0,
                a = 0),
            ...
            function Ci(e) {
                ...
                if ("month" === (e = re(e)) || "quarter" === e || "year" === e)
                    ...
                    switch (t = this._days + Math.round(Yi(this._months)),
                    e) {
                    case "week":
                        return t / 7 + r / 6048e5;
                    case "day":
            ...
            function io(e, t) {
                ...
                "object" == typeof t && (i = Object.assign({}, eo, t),
            ...
            function lo() {
                if (!this.isValid())
                    return this.localeData().invalidDate();
                var e, t, n, r, s, i, o, a, l = oo(this._milliseconds) / 1e3, u = oo(this._days), c = oo(this._months), d = this.asSeconds();
                return d ? (e = ue(l / 60),
                t = ue(e / 60),
                l %= 60,
                e %= 60,
                ...
                s + "P" + (n ? i + n + "Y" : "") + (c ? i + c + "M" : "") + (u ? o + u + "D" : "") + (t || e || l ? "T" : "") + (t ? a + t + "H" : "") + (e ? a + e + "M" : "") + (l ? a + r + "S" : "")) : "P0D"
            }
            var uo = or.prototype;
            return uo.isValid = sr,
            uo.abs = xi,
            uo.add = Si,
            uo.subtract = Mi,
            uo.as = Ci,
    ...
    function Gn(e) {
        ...
        return void 0 !== e[7] && (i.guessInput = e[7]),
        t = new Yt({
            props: i
        }),
        e[22](t),
        H.push((()=>function(e, t, n) {
            const r = e.$$.props[t];
            void 0 !== r && (e.$$.bound[r] = n,
            n(e.$$.ctx[r]))
        }(t, "guessInput", s))),
        t.$on("guess", e[15]),
        {
    ...
    function En(e) {
        ...
        return {
            ...
            m(r, y) {
                ...
                H && H.m(c, null),
                O = !0,
                P || (L = [S(An, "resize", e[17]), S(An, "resize", e[18])],
                P = !0)
            },
            p(e, t) {
                e[10].isActive ? A ? (A.p(e, t),
                1024 & t[0] && Z(A, 1)) : (A = Nn(e),
                A.c(),
                Z(A, 1),
                A.m(c, d)) : A && (J(),
                q(A, 1, 1, (()=>{
                ...
                Y.$set(s),
                !e[5].hasFinished && e[8].gameIsActive ? H ? (H.p(e, t),
                288 & t[0] && Z(H, 1)) : (H = Gn(e),
                H.c(),
                Z(H, 1),
                H.m(c, null)) : H && (J(),
                q(H, 1, 1, (()=>{
    ...
    function jn(e, t, n) {
        ...
        var c, d;
        void 0 !== document.hidden ? (c = "hidden",
        d = "visibilitychange") : void 0 !== document.msHidden ? (c = "msHidden",
        d = "msvisibilitychange") : void 0 !== document.webkitHidden && (c = "webkitHidden",
        d = "webkitvisibilitychange"),
        void 0 === document.addEventListener || void 0 === c || document.addEventListener(d, (function() {
        ...
        null == localStorage.getItem("firstTime") && (_("help", "how to play"),
        ...
        , function(e) {
            l.hasStarted || (pe("startGame#" + l.id, {
                name: "startGame"
            }),
            pe("startGame", {
                name: "startGame"
        ...
        , function(e) {
            ...
            n(5, f.guessList = v, f),
            localStorage.setItem("userStats", JSON.stringify(h)),
            v.length != Vt.maxAttempts && 1 != s || (o = s,
