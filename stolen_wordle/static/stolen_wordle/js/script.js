...
this.wordle.bundle = function(e) {
    ...
    function y(e, a) {
        return function(e) {
            ...
            var t, o, r = [], n = !0, i = !1;
            try {
                for (s = s.call(e); !(n = (t = s.next()).done) && (r.push(t.value),
                !a || r.length !== a); n = !0)
                    ;
            } catch (e) {
                i = !0,
    ...
    var F, W = C["__core-js_shared__"], Y = (F = /[^.]+$/.exec(W && W.keys && W.keys.IE_PROTO || "")) ? "Symbol(src)_1." + F : "";
    ...
    var me, he = function(e, a, s) {
        ...
        return e
    }, ye = "object" == (void 0 === e ? "undefined" : a(e)) && e && !e.nodeType && e, ge = ye && "object" == ("undefined" == typeof module ? "undefined" : a(module)) && module && !module.nodeType && module, be = ge && ge.exports === ye ? C.Buffer : void 0, fe = be ? be.allocUnsafe : void 0;
    var ke = C.Uint8Array;
    function ve(e, a) {
    ...
    function ra(e, a) {
        var s = Me(e)
          ...
          , l = i.length;
        for (var d in e)
            !a && !oa.call(e, d) || n && ("length" == d || o && ("offset" == d || "parent" == d) || r && ("buffer" == d || "byteLength" == d || "byteOffset" == d) || ta(d, l)) || i.push(d);
        return i
    }
    ...
    fa((function(e, s) {
        var t = -1
          ...
          , r = o > 1 ? s[o - 1] : void 0
          , n = o > 2 ? s[2] : void 0;
        for (r = ka.length > 3 && "function" == typeof r ? (o--,
        r) : void 0,
        n && function(e, s, t) {
            if (!D(t))
                return !1;
    ...
    function $a(e, a) {
        ...
        return Math.floor(Math.random() * Aa.length)
    }
    function Pa(e) {
        var s = Na(e);
        return Aa[s];
        ...
        return o(t, [{
            ...
            value: function() {
                if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
                            ...
                            for (var t = 0; t < s.length; t++)
                                if (s[t] === Ia && e[t] !== a[t])
                                    return {
                                        ...
                                        r = ["th", "st", "nd", "rd"],
                                        n = o % 100,
                                        o + (r[(n - 20) % 10] || r[n] || r[0])), " letter must be ").concat(a[t].toUpperCase())
                                    };
                    ...
                    var n = function(e, a) {
                        for (var s = Array(a.length).fill(Ca), t = Array(a.length).fill(!0), o = Array(a.length).fill(!0), r = 0; r < e.length; r++)
                            e[r] === a[r] && o[r] && (s[r] = Ia,
                            t[r] = !1,
                            o[r] = !1);
            ...
            value: function() {
                ...
                this.$game.addEventListener("game-last-tile-revealed-in-row", (function(a) {
                    ...
                    (a.path || a.composedPath && a.composedPath()).includes(s) && ([Za, es].includes(e.gameStatus) && (e.restoringFromLocalStorage ? e.showStatsModal() : (e.gameStatus === Za && (s.setAttribute("win", ""),
                ...
                this.shadowRoot.addEventListener("game-setting-change", (function(a) {
                    ...
                    switch (t) {
                    case "hard-mode":
                        return void (r ? e.addToast("Hard mode can only be enabled at the start of a round", 1500, !0) : (e.hardMode = o,
                        ja({
                            hardMode: o
                        })))
                    }
    ...
    var ls = [["q", "w", "e", "r", "t", "y", "u", "i", "o", "p"], ["-", "a", "s", "d", "f", "g", "h", "j", "k", "l", "-"], ["↵", "z", "x", "c", "v", "b", "n", "m", "←"]]
      , ds = function(e) {
        n(t, e);
        var a = h(t);
        function t() {
                ...
                ls.forEach((function(a) {
                    ...
                    a.forEach((function(e) {
                        ...
                        if (e >= "a" && e <= "z" || "←" === e || "↵" === e) {
                            ...
                            (a = is.content.cloneNode(!0).firstElementChild).classList.add(1 === e.length ? "half" : "one");
                        s.appendChild(a)
                    }
                    )),
